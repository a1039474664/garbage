    ...
    <div class="login_warp">
      ...
      <div>
        <div v-show="cur==0" class="Cbody_item">
          <el-form :model="ReginForm" status-icon :rules="mobileRule" ref="ReginForm" style="padding: 20px;"
                   class="demo-ruleForm">
            <el-form-item prop="mobile">
              <el-input type="text" v-model="ReginForm.mobile" autocomplete="off" placeholder="请输入手机号码"
                        maxlength="11"></el-input>
            </el-form-item>
            <el-form-item prop="code">
              <div>
                <el-input type="text" v-model="ReginForm.code" autocomplete="off" placeholder="请输入验证码"
                          style="width: 60%;" maxlength="6"></el-input>
                <el-button v-show="sendAuthCode" style="margin-left: 10px;" type="text"
                           @click="getAuthCode('ReginForm')">获取验证码
                </el-button>
        ...
        <div v-show="cur==1">
          <el-form :model="loginForm" status-icon :rules="rule" ref="loginForm" style="padding: 20px;"
                   class="demo-ruleForm">
