<template>
  <div style="background-color: white;">
    ...
    <div style="background-color: white;">
      <el-form :model="registerForm" status-icon :rules="rule" ref="registerForm" label-width="80px"
        ...
        <el-form-item label="电话号码" prop="mobile">
          <el-input type="text" v-model="registerForm.mobile" autocomplete="off" placeholder="用于密码找回"
        ...
        <el-form-item label="重复密码" prop="againPassword">
          <el-input type="password" v-model="registerForm.againPassword" autocomplete="off"
